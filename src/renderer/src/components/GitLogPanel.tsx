...
/**
 * Scrollable commit history of the workspace; fetches on mount. Fills its
 * container: rendered directly as the Git log tab's content, and wrapped in
 * panel chrome by GitLogPanel below.
 */
export function GitLogPane() {
  ...
  return (
    <div className="h-full w-full flex-1 overflow-y-auto bg-zinc-950">
      {loading ? (
...
/**
 * Right-hand panel: GitLogPane wrapped in panel chrome, toggled by the
 * Git log button's side-panel action in the sidebar.
 */
